  ...
  return showFirstSection ? (
    <div className="flex flex-col mt-5">
      {topicTitle && topicTitle.length ? (
        <MotionDiv>
          <div className="flex justify-center">
            <h3 className="my-1 text-lg font-bold px-5 py-2 bg-blue-100 rounded-lg dark:bg-slate-900 dark:text-green-400">
              {topicTitle}
            </h3>
          </div>
        </MotionDiv>
      ...
      {category && category.length ? (
        <MotionDiv>
          <div className="flex justify-center">
            <h3 className="my-2 font-bold px-5 py-2 bg-red-50 rounded-lg uppercase dark:bg-slate-700 dark:text-green-500">
              {category}
            </h3>
          </div>
        </MotionDiv>
