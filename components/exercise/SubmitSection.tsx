        ...
        <div className='flex flex-col mt-5'>
          <Spin spinning={ createLoading}>
            <div className='flex justify-center'>
                {topicTitle.length ? <h3 className='my-1 text-lg font-bold px-5 py-2 bg-blue-100 rounded-lg uppercase shadow dark:bg-slate-900 dark:text-green-400'>{topicTitle}</h3> : null}
            </div>
            ...
            <div className='flex justify-center w-full mt-5 text-white' hidden={!isPlaying}>
              <TextArea
